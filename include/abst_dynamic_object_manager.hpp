...
public:
        ...
        : AbstManager()
    {
        ...
        m_collision_false_fix_object_func = std::array<std::function<void(int)>, 4>{
            [this](int i) {},
            [this](int i) {},
            [this](int i) { m_data.at(i)->setGravity(0.1); },
            [this](int i) {}};
    }

    //void updateCollisionWithFixObject(std::unique_ptr<AbstFixObjectManager>& fix_object_manager)
    void updateCollisionWithFixObject(std::unique_ptr<FixBlockManager>& fix_object_manager)
    {
